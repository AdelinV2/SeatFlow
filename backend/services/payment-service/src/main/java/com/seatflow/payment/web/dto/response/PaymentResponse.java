...
public record PaymentResponse(
    ...
    @Schema(description = "Authoritative event session identifier (audit)") UUID eventSessionId,
    @Schema(description = "Immutable session start instant") Instant sessionStartsAt,
    @Schema(description = "Immutable session end instant") Instant sessionEndsAt,
